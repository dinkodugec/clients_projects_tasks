...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Edit a Client</div>
                <div class="card-body">
                    <form autocomplete="off" method="POST" action="/client/{{$client->id}}">
                        @csrf
                        @method('PUT')
                        ...
                        <input class="btn btn-primary mt-4" type="submit" value="Edit a Client">
                    </form>
                    @if ($errors->any())
